...
def aggresive_score(game, player):
...
def end_game(game, player):
    ...
    if num_blank_spaces < 0.2*num_spaces:
        return float(own_moves - (1.5 * opp_moves))
    else:
...
def center_score(game, player):
    ...
    if own_loc in center_moves:
        own_cent = 1
    else:
        own_cent = -1

    return float(own_cent)
...
def custom_score(game, player):
    ...
    return aggresive_score(game, player) + center_score(game, player)
        ...
        **********************************************************************
        ...
        try:
            ...
            if self.iterative:
                ...
                while True:
                    depth = depth + 1
                    _, move = search(game, depth)
            else:
                _, move = search(game, self.search_depth)
